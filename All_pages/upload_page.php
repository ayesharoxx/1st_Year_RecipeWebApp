...
<body> 
    ...
    <div class = "topNavHeader">
        ...
        <!-- <div class = "loginRegister">
            <button onclick="window.location.href='https://google.com';" class = "inputStyle" type="=button">Register</button>
            <button onclick="window.location.href='https://google.com';" class = "inputStyle" type="=button">Login</button>
        </div> -->
        <?php
            ...
            echo(' 
                ...
                <button onclick="window.location.href=\'mainPageLoggedIn2.php?\';" class = "inputStyle" type="=button">Log Out</button>
            ');
            echo('</div></div>');
        ?>
    </div>
        ...
        <h1>Upload Recipe</h1>
            ...
            <?php
                function display_form()
                {
                    ...
                    $username = $_GET['user_name'];
                    echo('
                    <form method = \'POST\' enctype="multipart/form-data" action = "upload_page.php?user_name='.$username.'&user_id='.$userid.'">
                    <div class="columns">
                ...
                function upload()
                {
                    ...
                    $auth_name = $_GET['user_name'];
                    $auth_id = $_GET['user_id'];
                ...
                {
                    echo('<div class="uploadPage">
                        <a href="mainPageLoggedIn2.php">
                            <button class = "uploadedButton" type = "button">Recipe Uploaded<br>Click to go to Home Page</button></a>
